...
impl Accelerator {
  ...
  fn key_equivalent(self) -> String {
    match self.key {
      ...
      KeyCode::F25 => "\u{F71C}".into(),
      KeyCode::F26 => "\u{F71D}".into(),
      KeyCode::F27 => "\u{F71E}".into(),
      KeyCode::F28 => "\u{F71F}".into(),
      KeyCode::F29 => "\u{F720}".into(),
      KeyCode::F30 => "\u{F721}".into(),
      KeyCode::F31 => "\u{F722}".into(),
      KeyCode::F32 => "\u{F723}".into(),
      KeyCode::F33 => "\u{F724}".into(),
      KeyCode::F34 => "\u{F725}".into(),
      KeyCode::F35 => "\u{F726}".into(),
      // from NSText.h
