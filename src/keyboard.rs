  ...
  pub(crate) fn to_keycode(&self) -> Option<Vec<KeyCode>> {
    match self {
      Key::Character(char) => match char.to_lowercase().as_str() {
        ...
        "d" => Some(vec![KeyCode::KeyD]),
        "e" => Some(vec![KeyCode::KeyE]),
        "f" => Some(vec![KeyCode::KeyF]),
        "g" => Some(vec![KeyCode::KeyG]),
        "h" => Some(vec![KeyCode::KeyH]),
        "i" => Some(vec![KeyCode::KeyI]),
        "j" => Some(vec![KeyCode::KeyJ]),
        "k" => Some(vec![KeyCode::KeyK]),
        "l" => Some(vec![KeyCode::KeyL]),
        "m" => Some(vec![KeyCode::KeyM]),
        "n" => Some(vec![KeyCode::KeyN]),
        "o" => Some(vec![KeyCode::KeyO]),
        "p" => Some(vec![KeyCode::KeyP]),
        "q" => Some(vec![KeyCode::KeyQ]),
        "r" => Some(vec![KeyCode::KeyR]),
        "s" => Some(vec![KeyCode::KeyS]),
        "t" => Some(vec![KeyCode::KeyT]),
      ...
      Key::Alt => Some(vec![KeyCode::AltLeft, KeyCode::AltRight]),
      Key::CapsLock => Some(vec![KeyCode::CapsLock]),
      Key::Control => Some(vec![KeyCode::ControlLeft]),
      Key::Fn => Some(vec![KeyCode::Fn]),
      Key::FnLock => Some(vec![KeyCode::FnLock]),
      Key::NumLock => Some(vec![KeyCode::NumLock]),
      Key::ScrollLock => Some(vec![KeyCode::ScrollLock]),
      Key::Shift => Some(vec![KeyCode::ShiftLeft]),
      Key::Hyper => Some(vec![KeyCode::Hyper]),
      Key::Super => Some(vec![KeyCode::SuperLeft]),
      Key::Enter => Some(vec![KeyCode::Enter]),
      Key::Tab => Some(vec![KeyCode::Tab]),
      Key::Space => Some(vec![KeyCode::Space]),
      Key::ArrowDown => Some(vec![KeyCode::ArrowDown]),
      Key::ArrowLeft => Some(vec![KeyCode::ArrowLeft]),
      Key::ArrowRight => Some(vec![KeyCode::ArrowRight]),
      Key::ArrowUp => Some(vec![KeyCode::ArrowUp]),
      Key::End => Some(vec![KeyCode::End]),
      Key::Home => Some(vec![KeyCode::Home]),
      Key::PageDown => Some(vec![KeyCode::PageDown]),
      Key::PageUp => Some(vec![KeyCode::PageUp]),
      Key::Backspace => Some(vec![KeyCode::Backspace]),
      Key::Clear => Some(vec![KeyCode::NumpadClear]),
      Key::Copy => Some(vec![KeyCode::Copy]),
      Key::Cut => Some(vec![KeyCode::Cut]),
      Key::Delete => Some(vec![KeyCode::Delete]),
      Key::Insert => Some(vec![KeyCode::Insert]),
      Key::Paste => Some(vec![KeyCode::Paste]),
      Key::Undo => Some(vec![KeyCode::Undo]),
      Key::Again => Some(vec![KeyCode::Again]),
      Key::ContextMenu => Some(vec![KeyCode::ContextMenu]),
      Key::Escape => Some(vec![KeyCode::Escape]),
      Key::Find => Some(vec![KeyCode::Find]),
      Key::Help => Some(vec![KeyCode::Help]),
      Key::Pause => Some(vec![KeyCode::Pause]),
      Key::Play => Some(vec![KeyCode::MediaPlayPause]),
      Key::Props => Some(vec![KeyCode::Props]),
      Key::Select => Some(vec![KeyCode::Select]),
      Key::Eject => Some(vec![KeyCode::Eject]),
      Key::Power => Some(vec![KeyCode::Power]),
      Key::PrintScreen => Some(vec![KeyCode::PrintScreen]),
      Key::WakeUp => Some(vec![KeyCode::WakeUp]),
      // todo validate Mail's action
      Key::MailForward => Some(vec![KeyCode::LaunchMail]),
      Key::MailReply => Some(vec![KeyCode::LaunchMail]),
      Key::MailSend => Some(vec![KeyCode::LaunchMail]),

      Key::MediaClose => Some(vec![KeyCode::MediaStop]),
      Key::MediaFastForward => Some(vec![KeyCode::MediaTrackNext]),
      Key::MediaPause => Some(vec![KeyCode::MediaTrackNext]),
      Key::MediaPlay => Some(vec![KeyCode::MediaPlayPause]),
      Key::MediaPlayPause => Some(vec![KeyCode::MediaPlayPause]),
      Key::MediaRewind => Some(vec![KeyCode::MediaTrackPrevious]),

      Key::Open => Some(vec![KeyCode::Open]),
      Key::Key11 => todo!(),
      Key::Key12 => todo!(),
      ...
      Key::AudioVolumeDown => Some(vec![KeyCode::AudioVolumeDown]),
      ...
      Key::F1 => Some(vec![KeyCode::F1]),
      Key::F2 => Some(vec![KeyCode::F2]),
      Key::F3 => Some(vec![KeyCode::F3]),
      Key::F4 => Some(vec![KeyCode::F4]),
      Key::F5 => Some(vec![KeyCode::F5]),
      Key::F6 => Some(vec![KeyCode::F6]),
      Key::F7 => Some(vec![KeyCode::F7]),
      Key::F8 => Some(vec![KeyCode::F8]),
      Key::F9 => Some(vec![KeyCode::F9]),
      Key::F10 => Some(vec![KeyCode::F10]),
      Key::F11 => Some(vec![KeyCode::F11]),
      Key::F12 => Some(vec![KeyCode::F12]),
      Key::F13 => Some(vec![KeyCode::F13]),
      Key::F14 => Some(vec![KeyCode::F14]),
      Key::F15 => Some(vec![KeyCode::F15]),
      Key::F16 => Some(vec![KeyCode::F16]),
      Key::F17 => Some(vec![KeyCode::F17]),
      Key::F18 => Some(vec![KeyCode::F18]),
      Key::F19 => Some(vec![KeyCode::F19]),
      Key::F20 => Some(vec![KeyCode::F20]),
      Key::F21 => Some(vec![KeyCode::F21]),
      Key::F22 => Some(vec![KeyCode::F22]),
      Key::F23 => Some(vec![KeyCode::F24]),
      Key::F24 => Some(vec![KeyCode::F25]),
      Key::F25 => Some(vec![KeyCode::F26]),
      Key::F26 => Some(vec![KeyCode::F27]),
      Key::F27 => Some(vec![KeyCode::F28]),
      Key::F28 => Some(vec![KeyCode::F29]),
      Key::F29 => Some(vec![KeyCode::F30]),
      Key::F30 => Some(vec![KeyCode::F31]),
      Key::F31 => Some(vec![KeyCode::F31]),
      Key::F32 => Some(vec![KeyCode::F32]),
      Key::F33 => Some(vec![KeyCode::F33]),
      Key::F34 => Some(vec![KeyCode::F34]),
      Key::F35 => Some(vec![KeyCode::F35]),
      _ => None,
    }
  }
}
